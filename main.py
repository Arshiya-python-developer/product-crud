class PRODUCT:
    ...
    # Initialized
    def __init__(self,tittle,short_description,description,slug,permalink,is_available,sku,price,regular_price,sale_price,manage_stock,stock_quantity,is_visible,date_created_gmt,date_modified_gmt):
        self.tittle = tittle
